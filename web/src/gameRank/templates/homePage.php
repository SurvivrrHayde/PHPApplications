...
<body>
  ...
  <header class="p-3 mb-3 border-bottom navbar-dark bg-dark">
    <div class="js-dynamic-col">
        <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex flex-wrap align-items-center js-nav">
            </div>
        </div>
    </div>
</header>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js"
    ...
    const dynamicCol = document.querySelector('.js-dynamic-col');
    const navPlaceholder = document.querySelector('.js-nav');

    if (userLoggedIn) {
        dynamicCol.className = 'col-md-11 offset-md-1';

        navPlaceholder.innerHTML = `
            <ul class="nav col-12 col-lg-auto mb-2 justify-content-center mb-md-0 mr-1">
                <li><a href="?command=showHomepage" class="nav-link px-2 link-body-emphasis">Home</a></li>
                <li><a href="?command=showGroups" class="nav-link px-2 link-body-emphasis" id="fix-me">Your Groups</a></li>
                <li><a href="?command=showJoinGroup" class="nav-link px-2 link-body-emphasis">Join Group</a></li>
                <li><a href="?command=showCreateGroup" class="nav-link px-2 link-body-emphasis">Create Group</a></li>
            </ul>
            <div class="dropdown text-end">
                ...
                <ul class="dropdown-menu text-small">
                    ...
                    <li><a class="dropdown-item" href="?command=showGroups">Your Groups</a></li>
        ...
        dynamicCol.className = 'col-md-10 offset-md-1';

        navPlaceholder.innerHTML = `
            <a class="btn btn-outline-primary me-2" href="?command=showLogin">Log In</a>
            <a class="btn btn-primary" href="?command=showSignup">Register</a>`;
    }
});
    </script>
</body>
