  ...
  <body>
    ...
    <div class="container text-center">
      ...
      <ul class="user-list">
        ...
        <li>
          <img
            src="images/isabelle.png"
            alt="Margaret's profile picture"
            class="rounded-circle"
            width="30"
            height="30"
          >
    ...
    <div class="card-group justify-content-start">
      ...
      <div class="col">
        <div class="card h-100">
          <img
            src="images/sonicmania.jpg"
            class="card-img-top"
            alt="Sonic Mania cover"
          >
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100">
          <img
            src="images/persona3reload.jpg"
            class="card-img-top"
            alt="Persona 3 Reload cover"
          >
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100">
          <img
            src="images/katamaridamacy.jpg"
            class="card-img-top"
            alt="Katamari Damacy cover"
          >
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100">
          <img
            src="images/supermariobros3.jpg"
            class="card-img-top"
            alt="Super Mario Bros. 3 cover"
          >
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100">
          <img
            src="images/finalfantasyxiv.jpg"
            class="card-img-top"
            alt="Celeste cover"
          >
          <div class="card-body">
