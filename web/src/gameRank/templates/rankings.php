...
<html lang="en">
  ...
  <body>
    ...
    <div class="d-flex justify-content-left">
      <a tabindex="0" class="btn btn-primary" href="rankgroup.html" role="button">
        Back to Group
      </a>
    </div>
        ...
        <div class="col-md-8">
                ...
                <div class="card-body">
                  ...
                  <div class="col-md-5">
                    <ul class="list-group">
                      ...
                      <li
                        class="list-group-item d-flex justify-content-between align-items-center ishmael"
                      >
                        <img
                          src="images/mario.png"
                          alt="User2"
          ...
          <div class="card mb-3" style="max-width: 540px">
            <div class="row g-0">
              <div class="col-md-4">
                <img
                  src="images/pokemonmysterydungeon.jpg"
                  class="img-fluid rounded-start"
                  alt="Minecraft cover"
                >
              </div>
